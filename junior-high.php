...
<head>
    ...
    <title>Junior High School - MSU Buug Campus</title>
...
<body>
   ...
   <!-- TOP BAR -->
    ...
    <!-- JUNIOR HIGH SCHOOL CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">Junior High School Department</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center">
                    ...
                    <p class="lead mb-0" style="font-size: 1.3rem; line-height: 1.8;">
                        "The MSU – Buug LHS envisions quality secondary education for the development of a well – rounded individual."
                    </p>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center">
                    ...
                    <p class="lead mb-0" style="font-size: 1.3rem; line-height: 1.8;">
                        "To produce completers who are imbued with the value of scientific knowledge and possess a deep sense of commitment to the development and preservation of man and his environment."
                    </p>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">Through concerted efforts of discipline, the MSU – Buug Laboratory High School aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>Develop the interest and attitudes of students, and equip them with knowledge, skills and experience in preparation for senior high school;</li>
                        <li>Inculcate value of loyalty, honesty, commitment, dedication to service, moral integrity, self-reliance, and love of God and country; and</li>
                        <li>Train students for independent, critical, analytical, logical, and creative thinking in decision-making, and maximize the use of potentials for dedicated service to this fellowman, country, and to God.</li>
                    </ul>
                </div>
            </div>
        </div>
