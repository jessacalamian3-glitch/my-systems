<?php
$page_title = "Vice Chancellor for Planning & Development";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Vice Chancellor for Planning & Development | MSU Buug</title>
    ...
    <div class="container mt-5">
        <div class="card shadow">
            <div class="card-header" style="background: #8B0000; color: white;">
                <h2 class="mb-0">Vice Chancellor for Planning & Development</h2>
            </div>
            <div class="card-body">
