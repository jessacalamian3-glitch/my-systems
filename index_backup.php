...
.header {
 ...
 /* WELCOME CAROUSEL STYLES - ZERO SPACING */
        ...
        .slide-1 { background-image: url('images/logos.jpg'); }
        .slide-2 { background-image: url('images/femsusco.jpeg'); }
        .slide-3 { background-image: url('images/54.jpg'); }
        .slide-4 { background-image: url('images/msu.jpg'); }
                            ...
                            <?php if (!empty($events)): ?>
                                <?php foreach($events as $event): ?>
                                    <a href="view_event.php?id=<?= $event['id'] ?>" class="clickable-item">
                                        ...
                                        <p class="item-desc"><?= htmlspecialchars($event['location']) ?></p>
                                    </a>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <div class="clickable-item">
                                    <div class="item-date">No upcoming events</div>
                                    <h4 class="item-title">Check back later for new events</h4>
                                    <p class="item-desc">We're preparing exciting events for our community.</p>
                                </div>
                            <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    collegeItems.forEach(item => {
        ...
        function openModule(moduleName) {
            switch(moduleName) {
                case 'transparency':
                    alert('Opening Transparency Module...');
                    // window.location.href = 'transparency.php';
                    break;
                case 'dataprivacy':
                    alert('Opening Data Privacy Module...');
                    // window.location.href = 'dataprivacy.php';
                    break;
                case 'electron':
                    alert('Opening Electron Technology Module...');
                    // window.location.href = 'electron.php';
                    break;
                default:
