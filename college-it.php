...
<head>
    ...
    <title>College of Information Technology - MSU Buug Campus</title>
...
.top-bar a[href*="library"]:hover {
    ...
    border-color: #9C27B0;
        ...
        /* COLLEGE OF INFORMATION TECHNOLOGY STYLES */
        .content-section {
        ...
        .card-header {
            background: linear-gradient(135deg, var(--it-blue), var(--it-light-blue));
            color: white;
            padding: 1.5rem;
...
<body>
   <!-- TOP BAR -->
    ...
    <!-- COLLEGE OF INFORMATION TECHNOLOGY CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Information Technology</h2>
            
            <!-- Hero Image -->
            <div class="text-center mb-5">
                <img src="IT.png" alt="MSU Buug College of Information Technology" class="hero-image">
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Information Technology aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To capacitate faculty members to achieve teaching excellence in information and communication technology and produce quality and technical researches;</li>
                        <li>To prepare our students to possess enduring skills and become morally upright, successful and engaged citizens in an increasingly diverse, technological and global society;</li>
                        <li>To produce graduates who are well-equipped with information and communication technology skills that are responsive to their would-be working environments.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Information Technology commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide technical seminar-workshops and trainings to the stakeholders;</li>
                        <li>To support faculty development programs and scholarship grants;</li>
                        <li>To upgrade the research outputs of the faculty members through involvement in research forum;</li>
                        <li>To instill the value of collaboration among faculty members through teamwork and team-building activities.</li>
                        <li>To strengthen the research skills of the students through attending research colloquia and conferences;</li>
                        <li>To involve students in extra-curricular and community-driven activities that strengthen social relationships, leadership and humanistic skills;</li>
                        <li>To forge linkages with other SUCs, government and private sectors.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-laptop-code me-2"></i>Programs Offered</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-laptop-code"></i>
                    </div>
                    <p class="lead">The College of Information Technology offers cutting-edge programs to prepare students for the digital age.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="program-card">
                                ...
                                <p class="program-description">A comprehensive program focusing on software development, networking, and information systems management.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--it-blue);">Program Features:</h5>
