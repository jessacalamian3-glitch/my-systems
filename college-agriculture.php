...
<head>
    ...
    <title>College of Agriculture - MSU Buug Campus</title>
...
<body>
   <!-- TOP BAR -->
    ...
    <!-- COLLEGE OF AGRICULTURE CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Agriculture</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Agriculture aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide quality education in agriculture and related fields through competent instruction, research, and extension services;</li>
                        <li>To produce graduates who are equipped with technical knowledge and skills in agriculture, and who are responsive to the needs of the community and the environment;</li>
                        <li>To promote sustainable agriculture and environmental conservation through research and community engagement.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Agriculture commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To enhance the curriculum and instructional resources for agriculture education;</li>
                        <li>To conduct research that addresses the needs of the agricultural sector;</li>
                        <li>To provide extension services that transfer technology and knowledge to farmers and the community;</li>
                        <li>To establish partnerships with government and non-government organizations for agricultural development;</li>
                        <li>To promote the adoption of sustainable agricultural practices;</li>
                        <li>To develop students' leadership and entrepreneurial skills in agriculture.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-seedling me-2"></i>Programs Offered</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-seedling"></i>
                    </div>
                    <p class="lead">The College of Agriculture offers comprehensive programs to prepare students for careers in agricultural sciences and sustainable farming.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Agronomy</h4>
                                <p class="program-description">Focuses on crop production, soil management, and sustainable agricultural practices for optimal yield and environmental conservation.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--agri-green);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Crop Production and Management</li>
                                    <li>Soil Science and Fertility</li>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Animal Science</h4>
                                <p class="program-description">Focuses on livestock production, animal nutrition, breeding, and health management for sustainable animal agriculture.</p>
                                ...
                                <ul class="program-features">
                                    ...
                                    <li>Animal Product Processing</li>
                                    <li>Dairy and Poultry Science</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Farming System</h4>
                                <p class="program-description">Integrates various agricultural components into sustainable farming systems that optimize resource use and productivity.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--agri-green);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Integrated Farming Systems</li>
                                    <li>Agroecology and Sustainable Practices</li>
                                    <li>Farm Planning and Management</li>
                                    <li>Agricultural Economics and Marketing</li>
                                    <li>Farm Mechanization and Technology</li>
                                    <li>Agricultural Extension and Education</li>
                                </ul>
                            </div>
                        </div>
                    </div>
