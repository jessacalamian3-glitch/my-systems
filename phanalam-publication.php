...
<head>
    ...
    <title>Phanalam Publication - MSU Buug Campus</title>
...
<body>
    ...
    <!-- PHANALAM PUBLICATION CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">Phanalam Publication</h2>

            <!-- Introduction Card -->
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-book-open me-2"></i>About Phanalam Publication</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-book-open"></i>
                    </div>
                    <p class="lead">The Premier Research and Academic Journal of MSU Buug Campus</p>
                </div>
                
                <p class="mb-4">Phanalam Publication serves as the flagship research journal of Mindanao State University - Buug Campus, dedicated to showcasing scholarly works, research findings, and academic discourses from faculty members, researchers, and graduate students.</p>
                
                <p class="mb-4">The publication aims to contribute to the advancement of knowledge across various disciplines while promoting research culture and academic excellence within the university community.</p>
                
                <p>Through rigorous peer-review processes and high editorial standards, Phanalam ensures the dissemination of quality research that addresses contemporary issues and contributes to societal development.</p>
            </div>

            <!-- Special Features -->
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-star me-2"></i>Publication Features</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-star"></i>
                    </div>
                    <p class="lead">Distinctive Characteristics of Phanalam Publication</p>
                </div>
                ...
                <div class="features-grid">
                    <div class="feature-card">
                        ...
                        <h4 class="feature-title">Peer-Reviewed</h4>
                        <p>All submissions undergo rigorous double-blind peer review by experts in respective fields.</p>
                    </div>
                    ...
                    <div class="feature-card">
                        ...
                        <h4 class="feature-title">Academic Excellence</h4>
                        <p>Promotes high-quality research and scholarly discourse across multiple disciplines.</p>
                    </div>
                    ...
                    <div class="feature-card">
                        ...
                        <p>Features research from various academic fields including sciences, humanities, and social sciences.</p>
                    </div>
                    ...
                    <div class="feature-card">
                        ...
                        <h4 class="feature-title">Research Focus</h4>
                        <p>Emphasizes original research, case studies, and innovative academic contributions.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-book me-2"></i>Publication Issues</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-book"></i>
                    </div>
                    <p class="lead">Explore Our Collection of Research Publications</p>
                </div>
                ...
                <div class="volume-grid">
                    ...
                    <div class="volume-card">
                        <div class="volume-header">
                            <h4 class="volume-title">Inaugural Issue</h4>
                            <div class="volume-date">Premiere Edition</div>
                        </div>
                        <img src="phanalam.png" alt="Phanalam Publication First Issue" class="volume-image">
                        <div class="volume-content">
                            <p class="volume-description">The inaugural issue of Phanalam Publication featuring groundbreaking research from MSU Buug faculty and researchers.</p>
                            <ul class="volume-features">
                                <li><i class="fas fa-check"></i> Peer-Reviewed Articles</li>
                                <li><i class="fas fa-check"></i> Research Papers</li>
                                <li><i class="fas fa-check"></i> Case Studies</li>
                                <li><i class="fas fa-check"></i> Literature Reviews</li>
                            </ul>
                            <a href="#" class="volume-button">Read Publication</a>
                        </div>
                    </div>
                    ...
                    <div class="volume-card">
                        <div class="volume-header">
                            <h4 class="volume-title">Volume 2</h4>
                            <div class="volume-date">Latest Research</div>
                        </div>
                        <img src="phanalam2.png" alt="Phanalam Publication Second Issue" class="volume-image">
                        <div class="volume-content">
                            <p class="volume-description">The second volume showcasing cutting-edge research and scholarly contributions from the academic community.</p>
                            <ul class="volume-features">
                                <li><i class="fas fa-check"></i> Original Research</li>
                                <li><i class="fas fa-check"></i> Empirical Studies</li>
                                <li><i class="fas fa-check"></i> Theoretical Papers</li>
                                <li><i class="fas fa-check"></i> Methodological Innovations</li>
                            </ul>
                            <a href="#" class="volume-button">Read Publication</a>
                        </div>
                    </div>
                    ...
                    <div class="volume-card">
                        <div class="volume-header">
                            <h4 class="volume-title">Volume 3</h4>
                            <div class="volume-date">Forthcoming</div>
                        </div>
                        <img src="https://via.placeholder.com/400x250/600000/FFFFFF?text=Volume+3+Coming+Soon" alt="Phanalam Publication Volume 3" class="volume-image">
                        <div class="volume-content">
                            <p class="volume-description">The upcoming volume currently accepting submissions for peer review and publication consideration.</p>
                            <ul class="volume-features">
                                <li><i class="fas fa-check"></i> Call for Papers Open</li>
                                <li><i class="fas fa-check"></i> Ongoing Peer Review</li>
                                <li><i class="fas fa-check"></i> Expected Release: 2024</li>
                                <li><i class="fas fa-check"></i> Special Theme Edition</li>
                            </ul>
                            <a href="#" class="volume-button">Submit Your Paper</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-users me-2"></i>Editorial Board</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-users"></i>
                    </div>
                    <p class="lead">Meet Our Distinguished Editorial Team</p>
                </div>
                
                <div class="team-grid">
                    <div class="team-card">
                        <img src="https://via.placeholder.com/100" alt="Editor-in-Chief" class="team-img">
                        <h4 class="team-name">Dr. Maria Santos</h4>
                        <p class="team-position">Editor-in-Chief</p>
                        <p class="team-department">College of Arts and Sciences</p>
                    </div>
                    
                    <div class="team-card">
                        <img src="https://via.placeholder.com/100" alt="Managing Editor" class="team-img">
                        <h4 class="team-name">Prof. Carlos Reyes</h4>
                        <p class="team-position">Managing Editor</p>
                        <p class="team-department">College of Education</p>
                    </div>
                    
                    <div class="team-card">
                        <img src="https://via.placeholder.com/100" alt="Associate Editor" class="team-img">
                        <h4 class="team-name">Dr. Amina Hassan</h4>
                        <p class="team-position">Associate Editor</p>
                        <p class="team-department">College of Agriculture</p>
                    </div>
                    
                    <div class="team-card">
                        <img src="https://via.placeholder.com/100" alt="Technical Editor" class="team-img">
                        <h4 class="team-name">Prof. James Lim</h4>
                        <p class="team-position">Technical Editor</p>
                        <p class="team-department">College of IT</p>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-clipboard-list me-2"></i>Submission Guidelines</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-clipboard-list"></i>
                    </div>
                    <p class="lead">How to Submit Your Research for Publication</p>
                </div>
                
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="text-center mb-3" style="color: var(--msu-green);">Submission Requirements</h5>
                        <ul class="volume-features">
                            <li><i class="fas fa-file-alt"></i> Original unpublished research</li>
                            <li><i class="fas fa-font"></i> APA 7th Edition formatting</li>
                            <li><i class="fas fa-wordpress"></i> 3000-8000 word count</li>
                            <li><i class="fas fa-user"></i> Author information page</li>
                            <li><i class="fas fa-sticky-note"></i> Abstract (150-250 words)</li>
                            <li><i class="fas fa-key"></i> 3-5 keywords</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <h5 class="text-center mb-3" style="color: var(--msu-green);">Review Process</h5>
                        <ul class="volume-features">
                            <li><i class="fas fa-search"></i> Initial editorial screening</li>
                            <li><i class="fas fa-user-friends"></i> Double-blind peer review</li>
                            <li><i class="fas fa-clock"></i> 4-6 weeks review period</li>
                            <li><i class="fas fa-edit"></i> Revision recommendations</li>
                            <li><i class="fas fa-check-circle"></i> Final editorial decision</li>
                            <li><i class="fas fa-print"></i> Publication schedule</li>
                        </ul>
                    </div>
                </div>
                
                <div class="text-center mt-4">
                    <a href="#" class="volume-button" style="max-width: 300px;">Download Full Guidelines</a>
                </div>
            </div>
            ...
            <div class="info-card text-center">
                <div class="card-header">
                    <h3><i class="fas fa-paper-plane me-2"></i>Contribute to Phanalam</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-paper-plane"></i>
                    </div>
                    <p class="lead">Share Your Research with the Academic Community</p>
                </div>
                
                <p class="mb-4">We invite faculty members, researchers, and graduate students to submit their original research for publication consideration. Join us in advancing knowledge and promoting academic excellence.</p>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 mb-3">
                        <a href="#" class="volume-button" style="background: var(--msu-dark);">Become a Reviewer</a>
                    </div>
                </div>
            </div>
        </div>
