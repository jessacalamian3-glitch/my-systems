...
<head>
    ...
    <title>College of Fisheries - MSU Buug Campus</title>
    ...
    <style>
        :root {
            ...
            --msu-cream: #FFF8E1;
            --footer-gray: #f8f9fa;
            --fisheries-blue: #1E90FF;        /* DodgerBlue for Fisheries */
            --fisheries-light-blue: #87CEEB;  /* SkyBlue for Fisheries */
            --fisheries-dark-blue: #000080;   /* Navy for Fisheries */
        }
...
.top-bar a[href*="library"]:hover {
    ...
    border-color: #9C27B0;
        ...
        /* COLLEGE OF FISHERIES STYLES - BLUE VERSION */
        .content-section {
        ...
        .content-section::before {
            ...
            background: 
                ...
                radial-gradient(circle at 80% 20%, rgba(30, 144, 255, 0.05) 0%, transparent 50%); /* Blue background */
        }
        ...
        .info-card {
            ...
            margin-bottom: 3rem;
            border-left: 5px solid var(--fisheries-blue);
            transition: all 0.3s ease;
            position: relative;
            overflow: hidden;
        }
        ...
        .card-header {
            background: linear-gradient(135deg, var(--fisheries-blue), var(--fisheries-light-blue));
            color: white;
            padding: 1.5rem;
        ...
        .program-card {
            ...
            margin-bottom: 2rem;
            transition: all 0.3s ease;
            border-top: 4px solid var(--fisheries-blue);
            height: 100%;
            position: relative;
            overflow: hidden;
        }
        ...
        .faculty-img {
            ...
            object-fit: cover;
            margin: 0 auto 1rem;
            border: 4px solid var(--fisheries-blue);
        }
...
<!-- TOP BAR -->
    ...
    <!-- COLLEGE OF FISHERIES CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Fisheries</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Fisheries aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To produce competent fisheries professionals equipped with scientific knowledge and technical skills;</li>
                        <li>To promote sustainable fisheries management, aquaculture development, and marine conservation;</li>
                        <li>To conduct research and extension services that address fisheries challenges and contribute to food security.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Fisheries commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide quality education in fisheries science, aquaculture, and marine biology;</li>
                        <li>To develop students' technical skills in fish farming, aquatic resource management, and fisheries technology;</li>
                        <li>To promote research on aquatic ecosystems, fish health, and sustainable aquaculture practices;</li>
                        <li>To foster marine conservation awareness and sustainable fishing practices among students and communities;</li>
                        <li>To establish partnerships with government agencies, NGOs, and fishing communities for fisheries development;</li>
                        <li>To prepare graduates for careers in fisheries, aquaculture, marine research, and aquatic resource management.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Fisheries offers comprehensive programs focused on sustainable fisheries and aquaculture development.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Science in Fisheries</h4>
                                <p class="program-description">Prepares students for careers in fisheries management, aquaculture, and marine resource conservation.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--fisheries-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Fisheries Biology and Ecology</li>
                                    <li>Aquaculture Systems and Management</li>
                                    <li>Fish Health and Disease Management</li>
                                    <li>Fisheries Policy and Governance</li>
                                    <li>Post-Harvest Technology and Quality Control</li>
                                    <li>Aquatic Resource Assessment</li>
                                    <li>Community-Based Fisheries Management</li>
                                    <li>Fisheries Research Methods</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Science in Marine Biology</h4>
                                <p class="program-description">Focuses on the scientific study of marine organisms, ecosystems, and conservation.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--fisheries-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Marine Ecology and Biodiversity</li>
                                    <li>Marine Organism Biology</li>
                                    <li>Coral Reef Ecology and Management</li>
                                    <li>Marine Conservation and Protected Areas</li>
                                    <li>Marine Pollution and Environmental Impact</li>
                                    <li>Oceanography and Marine Geology</li>
                                    <li>Marine Biotechnology</li>
                                    <li>Marine Research Methods</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Fisheries is equipped with modern facilities to support quality education and research.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Fisheries Laboratory</h4>
                                <p class="facility-description">Modern laboratory equipped for water quality analysis, fish nutrition studies, and aquatic research.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Aquaculture Ponds</h4>
                                <p class="facility-description">On-campus aquaculture facilities for practical training in fish farming and management.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Research Vessel</h4>
                                <p class="facility-description">Small research vessel for marine studies, sampling, and field research activities.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="quick-links">
                        ...
                        <ul class="quick-links-list">
                            ...
                            <li><a href="#"><i class="fas fa-flask"></i> Research Opportunities</a></li>
                            <li><a href="#"><i class="fas fa-ship"></i> Fieldwork Programs</a></li>
                            <li><a href="#"><i class="fas fa-users"></i> Faculty Directory</a></li>
                            <li><a href="#"><i class="fas fa-handshake"></i> Industry Partnerships</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="info-card">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="lead">Meet our dedicated faculty members who are experts in fisheries and marine sciences.</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="faculty-card">
                                        <img src="https://via.placeholder.com/120" alt="Dr. Elena Torres" class="faculty-img">
                                        <h4 class="faculty-name">Dr. Elena Torres</h4>
                                        <p class="faculty-position">Dean, College of Fisheries</p>
                                        <p class="faculty-qualifications">Ph.D. in Marine Biology, University of the Philippines</p>
                                        <p class="faculty-contact">etorres@msubuug.edu.ph</p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="faculty-card">
                                        <img src="https://via.placeholder.com/120" alt="Prof. Miguel Santos" class="faculty-img">
                                        <h4 class="faculty-name">Prof. Miguel Santos</h4>
                                        <p class="faculty-position">Department Head, Aquaculture</p>
                                        <p class="faculty-qualifications">M.S. in Fisheries, University of the Philippines Visayas</p>
