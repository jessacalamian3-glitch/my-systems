...
<head>
    ...
    <title>Senior High School - MSU Buug Campus</title>
...
.top-bar a[href*="library"]:hover {
    ...
    border-color: #9C27B0;
        ...
        .strand-subjects li:last-child {
            border-bottom: none;
        }

        .strand-subjects li::before {
            content: '•';
            color: var(--msu-green);
            font-weight: bold;
            position: absolute;
...
<body>
    ...
    <!-- SENIOR HIGH SCHOOL CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">Senior High School Department</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center">
                    ...
                    <p class="lead mb-0" style="font-size: 1.3rem; line-height: 1.8;">
                        "The MSU – Buug Senior High School envisions to produce globally competitive graduates equipped with 21st-century skills, ready for higher education, entrepreneurship, or employment."
                    </p>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center">
                    ...
                    <p class="lead mb-0" style="font-size: 1.3rem; line-height: 1.8;">
                        "To provide quality senior high education that fosters academic excellence, critical thinking, moral integrity, and social responsibility through a holistic and relevant curriculum."
                    </p>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-tasks me-2"></i>Objectives</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-tasks"></i>
                    </div>
                    <p class="lead">Through concerted efforts of discipline, the MSU – Buug Senior High School aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>Prepare students for higher education, entrepreneurship, or employment through specialized academic and technical-vocational tracks;</li>
                        <li>Develop students' potential through a holistic and relevant curriculum that fosters 21st-century skills;</li>
                        <li>Inculcate values of leadership, service, social responsibility, and moral integrity; and</li>
                        <li>Equip students with critical thinking, problem-solving, and communication skills necessary for success in their chosen fields.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-graduation-cap me-2"></i>Academic Tracks & Strands</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-graduation-cap"></i>
                    </div>
                    <p class="lead">MSU Buug Senior High School offers various tracks and strands to cater to students' diverse interests and career goals.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="strand-card">
                                ...
                                <h4 class="strand-title">Academic Track</h4>
                                <p class="strand-description">Prepares students for college education with specialized strands</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--msu-green);">Available Strands:</h5>
                                <ul class="strand-subjects">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="strand-card">
                                ...
                                <h4 class="strand-title">TVL Track</h4>
                                <p class="strand-description">Technical-Vocational-Livelihood track for job-ready skills</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--msu-green);">Available Strands:</h5>
                                <ul class="strand-subjects">
                                    <li><strong>ICT</strong> - Information and Communications Technology</li>
                                    <li><strong>HE</strong> - Home Economics</li>
                                    <li><strong>Agri-Fishery Arts</strong></li>
                                    <li><strong>Industrial Arts</strong></li>
                                </ul>
                            </div>
                        </div>
                    </div>
