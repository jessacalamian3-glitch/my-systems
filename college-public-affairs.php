...
<head>
    ...
    <title>College of Public Affairs - MSU Buug Campus</title>
    ...
    <style>
        :root {
            ...
            --msu-cream: #FFF8E1;
            --footer-gray: #f8f9fa;
            --public-dark-blue: #003366;        /* Dark blue for Public Affairs */
            --public-light-blue: #004C99;       /* Light dark blue for Public Affairs */
        }
        ...
        * {
        ...
        /* COLLEGE OF PUBLIC AFFAIRS CONTENT STYLES */
        .content-section {
            padding: 80px 0;
        ...
        .card-header {
            background: linear-gradient(135deg, var(--public-dark-blue), var(--public-light-blue));
            color: white;
            padding: 20px 30px;
        ...
        .program-card {
            ...
            border-left: 5px solid var(--public-dark-blue);
            transition: all 0.3s ease;
        }
        ...
        .systems-list, .core-values-list {
            list-style-type: none;
            padding: 0;
        }

        .systems-list li, .core-values-list li {
            padding: 5px 0;
            border-bottom: 1px solid rgba(255,255,255,0.1);
        }
...
<body>
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="research-colloquium-publication.php">The Research Colloquium Publication</a></li>
    ...
    <!-- COLLEGE OF PUBLIC AFFAIRS CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Public Affairs</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Public Affairs aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To produce competent public administrators and leaders who can effectively serve in government and public service organizations;</li>
                        <li>To promote good governance, ethical leadership, and sustainable development through quality education and research;</li>
                        <li>To develop professionals who are committed to public service excellence and responsive to the needs of society.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Public Affairs commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide comprehensive education in public administration and governance;</li>
                        <li>To develop students' analytical, leadership, and management skills for public service;</li>
                        <li>To promote research on public policy, governance, and development issues;</li>
                        <li>To foster ethical values and social responsibility among future public servants;</li>
                        <li>To establish partnerships with government agencies and civil society organizations;</li>
                        <li>To prepare graduates for careers in government, non-profit organizations, and international agencies.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Public Affairs offers specialized programs to prepare students for leadership roles in public service and governance.</p>
                </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-8 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Public Administration</h4>
                                <p class="program-description">Prepares students for careers in government service, public policy, and public management with strong foundation in governance and administration.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--public-dark-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Public Policy Analysis and Development</li>
                                    <li>Public Finance and Budget Management</li>
                                    <li>Organizational Theory and Behavior</li>
                                    <li>Local Governance and Administration</li>
                                    <li>Public Personnel Management</li>
                                    <li>Ethics and Accountability in Public Service</li>
