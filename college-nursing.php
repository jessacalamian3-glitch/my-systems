...
<head>
    ...
    <title>College of Nursing - MSU Buug Campus</title>
    ...
    <style>
        :root {
            ...
            --msu-cream: #FFF8E1;
            --footer-gray: #f8f9fa;
            --nursing-teal: #20B2AA;        /* LightSeaGreen for Nursing */
            --nursing-light-teal: #48D1CC;  /* MediumTurquoise for Nursing */
            --nursing-dark-teal: #008080;   /* Teal for Nursing */
        }
...
.top-bar a[href*="library"]:hover {
    ...
    border-color: #9C27B0;
        ...
        /* COLLEGE OF NURSING STYLES - BLUE-GREEN VERSION */
        .content-section {
        ...
        .content-section::before {
            ...
            background: 
                ...
                radial-gradient(circle at 80% 20%, rgba(32, 178, 170, 0.05) 0%, transparent 50%); /* Teal background */
        }
        ...
        .info-card {
            ...
            margin-bottom: 3rem;
            border-left: 5px solid var(--nursing-teal);
            transition: all 0.3s ease;
            position: relative;
            overflow: hidden;
        }
        ...
        .info-card::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, transparent, rgba(32, 178, 170, 0.05), transparent);
        ...
        .card-header {
            background: linear-gradient(135deg, var(--nursing-teal), var(--nursing-light-teal));
            color: white;
            padding: 1.5rem;
        ...
        .program-card {
            ...
            margin-bottom: 2rem;
            transition: all 0.3s ease;
            border-top: 4px solid var(--nursing-teal);
            height: 100%;
            position: relative;
            overflow: hidden;
        }
        ...
        .faculty-img {
            ...
            object-fit: cover;
            margin: 0 auto 1rem;
            border: 4px solid var(--nursing-teal);
        }
...
<body>
    ...
    <!-- COLLEGE OF NURSING CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Nursing</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Nursing aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To produce competent and compassionate nursing professionals equipped with scientific knowledge and clinical skills;</li>
                        <li>To promote evidence-based nursing practice, health promotion, and quality patient care;</li>
                        <li>To conduct research and community extension services that address health challenges and contribute to community wellness.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Nursing commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide quality education in nursing science, clinical practice, and healthcare ethics;</li>
                        <li>To develop students' clinical skills in patient assessment, nursing interventions, and healthcare management;</li>
                        <li>To promote research on nursing practice, patient outcomes, and healthcare delivery systems;</li>
                        <li>To foster compassionate care, ethical practice, and professional values among nursing students;</li>
                        <li>To establish partnerships with hospitals, clinics, and community health centers for clinical training;</li>
                        <li>To prepare graduates for careers in various healthcare settings and for local and international nursing licensure examinations.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Nursing offers comprehensive programs focused on excellence in nursing education and clinical practice.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Science in Nursing</h4>
                                <p class="program-description">Prepares students for professional nursing practice through rigorous academic coursework and extensive clinical training in various healthcare settings.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--nursing-teal);">Program Features:</h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="program-features">
                                            <li>Fundamentals of Nursing Practice</li>
                                    ...
                                    <div class="col-md-6">
                                        <ul class="program-features">
                                            ...
                                            <li>Clinical Practicum in Various Specialties</li>
                                            <li>Professional Nursing Ethics and Values</li>
                                            <li>Preparation for Nursing Licensure Examinations</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-university me-2"></i>College Facilities</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-university"></i>
                    </div>
                    <p class="lead">The College of Nursing is equipped with modern facilities to provide comprehensive nursing education and hands-on clinical training.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Nursing Skills Laboratory</h4>
                                <p class="facility-description">Fully-equipped laboratory with hospital beds, mannequins, and medical equipment for fundamental nursing skills practice.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Simulation Center</h4>
                                <p class="facility-description">High-fidelity simulation laboratory with advanced patient simulators for realistic clinical scenarios.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Nursing Library</h4>
                                <p class="facility-description">Comprehensive collection of nursing textbooks, journals, and online resources for research and study.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="info-card">
                <div class="card-header">
                    <h3><i class="fas fa-briefcase me-2"></i>Career Opportunities</h3>
                </div>
                <div class="text-center mb-4">
                    <div class="card-icon">
                        <i class="fas fa-briefcase"></i>
                    </div>
                    <p class="lead">Graduates of the Bachelor of Science in Nursing program have diverse career paths in various healthcare settings.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="career-card">
                                ...
                                <h4 class="career-name">Hospital Nursing</h4>
                                <p class="career-description">Staff nurse positions in medical-surgical units, emergency rooms, intensive care units, and specialty departments.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="career-card">
                                ...
                                <h4 class="career-name">Community Health</h4>
                                <p class="career-description">Public health nursing, school nursing, occupational health, and community-based healthcare programs.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="career-card">
                                ...
                                <h4 class="career-name">Nursing Education</h4>
                                <p class="career-description">Clinical instructors, nursing educators, and faculty positions in academic institutions.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Quick Links and Faculty Section -->
            <div class="row">
                <div class="col-md-4">
                    <div class="quick-links">
                        <h4 class="quick-links-title">Quick Links</h4>
                        <ul class="quick-links-list">
                            <li><a href="#"><i class="fas fa-book"></i> Curriculum</a></li>
                            <li><a href="#"><i class="fas fa-calendar-alt"></i> Academic Calendar</a></li>
                            <li><a href="#"><i class="fas fa-file-alt"></i> Admission Requirements</a></li>
                            <li><a href="#"><i class="fas fa-stethoscope"></i> Clinical Affiliations</a></li>
                            <li><a href="#"><i class="fas fa-hand-holding-medical"></i> Community Extension</a></li>
                            <li><a href="#"><i class="fas fa-users"></i> Faculty Directory</a></li>
                            <li><a href="#"><i class="fas fa-graduation-cap"></i> Student Organizations</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="info-card">
                        <div class="card-header">
                            <h3><i class="fas fa-chalkboard-teacher me-2"></i>Faculty & Staff</h3>
                        </div>
                        <div class="text-center mb-4">
                            <div class="card-icon">
                                <i class="fas fa-chalkboard-teacher"></i>
                            </div>
                            <p class="lead">Meet our dedicated faculty members who are experts in nursing education and clinical practice.</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="faculty-card">
                                        <img src="https://via.placeholder.com/120" alt="Dr. Elena Cruz" class="faculty-img">
                                        <h4 class="faculty-name">Dr. Elena Cruz</h4>
                                        <p class="faculty-position">Dean, College of Nursing</p>
                                        <p class="faculty-qualifications">Ph.D. in Nursing, Master of Science in Nursing</p>
                                        <p class="faculty-contact">ecruz@msubuug.edu.ph</p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="faculty-card">
                                        <img src="https://via.placeholder.com/120" alt="Prof. Miguel Reyes" class="faculty-img">
                                        <h4 class="faculty-name">Prof. Miguel Reyes</h4>
                                        <p class="faculty-position">Department Head, Medical-Surgical Nursing</p>
                                        <p class="faculty-qualifications">Master of Arts in Nursing, Certified Medical-Surgical Nurse</p>
                                        <p class="faculty-contact">mreyes@msubuug.edu.ph</p>
                                    </div>
                                </div>
                            </div>
                        </div>
