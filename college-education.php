...
<head>
    ...
    <title>College of Education - MSU Buug Campus</title>
    ...
    <style>
        :root {
            ...
            --msu-cream: #FFF8E1;
            --footer-gray: #f8f9fa;
            --coed-blue: #0066CC;        /* Blue color for Education */
            --coed-light-blue: #4D94FF;  /* Light blue for Education */
        }
...
.top-bar a[href*="library"]:hover {
    ...
    border-color: #9C27B0;
        ...
        /* COLLEGE OF EDUCATION STYLES - BLUE VERSION */
        .content-section {
        ...
        .content-section::before {
            ...
            background: 
                ...
                radial-gradient(circle at 80% 20%, rgba(0, 102, 204, 0.05) 0%, transparent 50%); /* Blue background */
        }
        ...
        .info-card {
            ...
            margin-bottom: 3rem;
            border-left: 5px solid var(--coed-blue); /* Blue border */
            transition: all 0.3s ease;
            position: relative;
            overflow: hidden;
        }
        ...
        .info-card::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(90deg, transparent, rgba(0, 102, 204, 0.05), transparent); /* Blue gradient */
        ...
        .card-header {
            background: linear-gradient(135deg, var(--coed-blue), var(--coed-light-blue)); /* Blue gradient */
            color: white;
            padding: 1.5rem;
        ...
        .objectives-list li:hover {
            color: var(--coed-blue); /* Blue color */
            transform: translateX(5px);
        }
        ...
        .program-card {
            ...
            margin-bottom: 2rem;
            transition: all 0.3s ease;
            border-top: 4px solid var(--coed-blue); /* Blue border */
            height: 100%;
            position: relative;
            overflow: hidden;
        }
...
<body>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="college-public-affairs.php" target="_blank">College of Public Affairs</a></li>
    ...
    <!-- COLLEGE OF EDUCATION CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Education</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Education aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To produce competent, committed, and compassionate educators who can meet the demands of the 21st-century learning environment;</li>
                        <li>To provide quality teacher education through innovative instruction, relevant research, and meaningful community engagement;</li>
                        <li>To develop future educators who are values-oriented, research-driven, and globally competitive.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Education commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide comprehensive teacher education programs that integrate theory and practice;</li>
                        <li>To develop students' pedagogical competence, content knowledge, and technological skills;</li>
                        <li>To foster research capabilities among faculty and students in the field of education;</li>
                        <li>To promote values formation and ethical standards in the teaching profession;</li>
                        <li>To establish partnerships with schools and communities for relevant field experiences;</li>
                        <li>To prepare graduates for licensure examinations and professional teaching careers.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Education offers comprehensive teacher education programs to prepare future educators.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Secondary Education major in English</h4>
                                <p class="program-description">Prepares students to become competent English teachers in secondary education with strong communication and literary skills.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--coed-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>English Language Teaching Methodologies</li>
                                    <li>World Literature and Philippine Literature</li>
                                    <li>Linguistics and Language Acquisition</li>
                                    <li>Creative and Academic Writing</li>
                                    <li>Language Assessment and Evaluation</li>
                                    <li>Teaching Practicum and Field Study</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Secondary Education major in Filipino</h4>
                                <p class="program-description">Focuses on developing competent Filipino language teachers with deep understanding of Philippine culture and literature.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--coed-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Filipino Language Teaching Strategies</li>
                                    <li>Philippine Literature and Cultural Studies</li>
                                    <li>Filipino Linguistics and Grammar</li>
                                    <li>Creative Writing in Filipino</li>
                                    <li>Language Curriculum Development</li>
                                    <li>Teaching Demonstration and Practice</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Secondary Education major in Mathematics</h4>
                                <p class="program-description">Prepares students to become effective mathematics teachers with strong analytical and problem-solving skills.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--coed-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Mathematics Content and Pedagogy</li>
                                    <li>Algebra, Geometry, and Calculus</li>
                                    <li>Statistics and Probability</li>
                                    <li>Technology in Mathematics Education</li>
                                    <li>Mathematical Problem Solving</li>
                                    <li>Mathematics Curriculum Development</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Secondary Education major in Sciences</h4>
                                <p class="program-description">Develops competent science teachers with strong foundation in biological and physical sciences.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--coed-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Science Teaching Methodologies</li>
                                    <li>Biology, Chemistry, and Physics</li>
                                    <li>Earth and Environmental Science</li>
                                    <li>Laboratory Management and Safety</li>
                                    <li>Science Research Methods</li>
                                    <li>Science Curriculum Development</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Elementary Education - General Education</h4>
                                <p class="program-description">Prepares students to become competent elementary teachers with comprehensive knowledge across various subject areas.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--coed-blue);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Elementary Education Foundations</li>
                                    <li>Teaching Strategies for Multiple Subjects</li>
                                    <li>Child and Adolescent Development</li>
                                    <li>Classroom Management and Assessment</li>
                                    <li>Educational Technology Integration</li>
                                    <li>Teaching Internship and Field Study</li>
                                </ul>
                            </div>
                        </div>
                    </div>
