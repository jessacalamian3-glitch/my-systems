...
<head>
    ...
    <title>College of Hospitality Management - MSU Buug Campus</title>
    ...
    <style>
        :root {
            ...
            --msu-cream: #FFF8E1;
            --footer-gray: #f8f9fa;
            --hospitality-orange: #FF8C00;        /* DarkOrange for Hospitality */
            --hospitality-light-orange: #FFA500;  /* Orange for Hospitality */
            --hospitality-dark-orange: #FF4500;   /* OrangeRed for Hospitality */
        }
...
.top-bar a[href*="library"]:hover {
    ...
    border-color: #9C27B0;
        ...
        /* COLLEGE OF HOSPITALITY MANAGEMENT STYLES - ORANGE VERSION */
        .content-section {
        ...
        .content-section::before {
            ...
            background: 
                ...
                radial-gradient(circle at 80% 20%, rgba(255, 140, 0, 0.05) 0%, transparent 50%); /* Orange background */
        }
        ...
        .section-title::after {
            ...
            width: 100px;
            height: 5px;
            background: var(--hospitality-orange);
            border-radius: 3px;
        }
        ...
        .info-card {
            ...
            margin-bottom: 3rem;
            border-left: 5px solid var(--hospitality-orange);
            transition: all 0.3s ease;
            position: relative;
            overflow: hidden;
        }
        ...
        .card-header {
            background: linear-gradient(135deg, var(--hospitality-orange), var(--hospitality-light-orange));
            color: white;
            padding: 1.5rem;
        ...
        .program-card {
            ...
            margin-bottom: 2rem;
            transition: all 0.3s ease;
            border-top: 4px solid var(--hospitality-orange);
            height: 100%;
            position: relative;
            overflow: hidden;
        }
        ...
        .faculty-img {
            ...
            object-fit: cover;
            margin: 0 auto 1rem;
            border: 4px solid var(--hospitality-orange);
        }
...
<body>
    ...
    <!-- COLLEGE OF HOSPITALITY MANAGEMENT CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Hospitality Management</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Hospitality Management aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To produce competent hospitality professionals equipped with industry knowledge and service skills;</li>
                        <li>To promote excellence in hospitality education, service quality, and industry standards;</li>
                        <li>To conduct research and extension services that address hospitality industry challenges and contribute to tourism development.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Hospitality Management commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide quality education in hospitality management, tourism, and related fields;</li>
                        <li>To develop students' technical skills in hotel operations, food service, and event management;</li>
                        <li>To promote research on hospitality trends, customer service, and tourism development;</li>
                        <li>To foster industry partnerships for internships, job placements, and curriculum enhancement;</li>
                        <li>To establish linkages with hotels, resorts, restaurants, and tourism enterprises for practical training;</li>
                        <li>To prepare graduates for careers in hotel management, tourism, food service, and event planning.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Hospitality Management offers comprehensive programs focused on excellence in hospitality service and management.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Science in Hospitality Management</h4>
                                <p class="program-description">Prepares students for leadership roles in the dynamic hospitality industry, focusing on hotel operations, food service, and tourism management.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--hospitality-orange);">Program Features:</h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="program-features">
                                            <li>Hotel and Resort Operations</li>
                                            <li>Food and Beverage Management</li>
                                            <li>Front Office Procedures</li>
                                    ...
                                    <div class="col-md-6">
                                        <ul class="program-features">
                                            ...
                                            <li>Tourism and Travel Management</li>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Hospitality Management is equipped with state-of-the-art facilities to provide hands-on training and industry-standard education.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Training Kitchen</h4>
                                <p class="facility-description">Fully-equipped commercial kitchen for culinary arts and food preparation training.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Mock Hotel Room</h4>
                                <p class="facility-description">Simulated hotel room for housekeeping and front office operations training.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="facility-card">
                                ...
                                <h4 class="facility-name">Food & Beverage Lab</h4>
                                <p class="facility-description">Dining and bar setup for food service and beverage management training.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">Graduates of Hospitality Management have diverse career paths in the growing hospitality and tourism industry.</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="career-card">
                                ...
                                <h4 class="career-name">Hotel Management</h4>
                                <p class="career-description">Front office, housekeeping, sales, and general management positions in hotels and resorts.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="career-card">
                                ...
                                <h4 class="career-name">Food Service</h4>
                                <p class="career-description">Restaurant management, culinary arts, catering, and food and beverage operations.</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="career-card">
                                ...
                                <h4 class="career-name">Event Management</h4>
                                <p class="career-description">Conference planning, wedding coordination, and special events management.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="quick-links">
                        ...
                        <ul class="quick-links-list">
                            ...
                            <li><a href="#"><i class="fas fa-briefcase"></i> Internship Opportunities</a></li>
                            <li><a href="#"><i class="fas fa-hotel"></i> Industry Partnerships</a></li>
                ...
                <div class="col-md-8">
                    ...
                    <div class="info-card">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="lead">Meet our dedicated faculty members who are experts in hospitality management and industry professionals.</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="faculty-card">
                                        <img src="https://via.placeholder.com/120" alt="Dr. Maria Santos" class="faculty-img">
                                        <h4 class="faculty-name">Dr. Maria Santos</h4>
                                        <p class="faculty-position">Dean, College of Hospitality Management</p>
                                        <p class="faculty-qualifications">Ph.D. in Hospitality Management, University of the Philippines</p>
                                        <p class="faculty-contact">msantos@msubuug.edu.ph</p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="faculty-card">
                                        <img src="https://via.placeholder.com/120" alt="Prof. Juan Dela Cruz" class="faculty-img">
                                        <h4 class="faculty-name">Prof. Juan Dela Cruz</h4>
                                        <p class="faculty-position">Department Head, Hotel Operations</p>
                                        <p class="faculty-qualifications">M.S. in Hospitality Management, Former Hotel General Manager</p>
                                        <p class="faculty-contact">jdelacruz@msubuug.edu.ph</p>
                                    </div>
                                </div>
                            </div>
                        </div>
