...
<head>
    ...
    <title>College of Arts and Sciences - MSU Buug Campus</title>
...
.top-bar a[href*="library"]:hover {
    ...
    border-color: #9C27B0;
        ...
        /* COLLEGE OF ARTS AND SCIENCES STYLES */
        .content-section {
        ...
        .info-card {
            ...
            margin-bottom: 3rem;
            border-left: 5px solid var(--arts-purple);
            transition: all 0.3s ease;
            position: relative;
            overflow: hidden;
        }
        ...
        .card-header {
            background: linear-gradient(135deg, var(--arts-purple), var(--arts-light-purple));
            color: white;
            padding: 1.5rem;
        ...
        .program-card {
            ...
            margin-bottom: 2rem;
            transition: all 0.3s ease;
            border-top: 4px solid var(--arts-purple);
            height: 100%;
            position: relative;
            overflow: hidden;
        }
...
<body>
    ...
    <!-- COLLEGE OF ARTS AND SCIENCES CONTENT SECTION -->
    <section class="content-section">
        <div class="container">
            <h2 class="section-title">College of Arts and Sciences</h2>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Arts and Sciences aims to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To provide a comprehensive liberal arts education that fosters critical thinking, creativity, and cultural awareness;</li>
                        <li>To develop students' communication skills and analytical abilities across various disciplines in the arts and sciences;</li>
                        <li>To prepare graduates for diverse careers and advanced studies through interdisciplinary learning and research.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">To achieve its goals, the College of Arts and Sciences commits to:</p>
                </div>
                
                <div class="objectives-container">
                    <ul class="objectives-list">
                        <li>To offer a curriculum that integrates humanities, social sciences, and natural sciences;</li>
                        <li>To foster critical thinking and analytical skills through rigorous academic programs;</li>
                        <li>To promote research and creative works that contribute to knowledge and societal development;</li>
                        <li>To develop students' communication skills in multiple languages and formats;</li>
                        <li>To provide opportunities for cultural exchange and global awareness;</li>
                        <li>To prepare students for leadership roles in various professional fields.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="lead">The College of Arts and Sciences offers diverse programs that combine theoretical knowledge with practical application.</p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Arts in English Language Studies</h4>
                                <p class="program-description">Focuses on the study of English language, literature, and communication for diverse professional applications.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--arts-purple);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>English Linguistics and Grammar</li>
                                    <li>World Literature in English</li>
                                    <li>Creative and Technical Writing</li>
                                    <li>Language Teaching Methodologies</li>
                                    <li>Cross-cultural Communication</li>
                                    <li>Research in Language Studies</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="program-card">
                                ...
                                <h4 class="program-title">Bachelor of Arts in Filipino</h4>
                                <p class="program-description">Focuses on the study of Filipino language, literature, and culture for academic and professional development.</p>
                                ...
                                <ul class="program-features">
                                    ...
                                    <li>Filipino Culture and Society</li>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="program-card">
                                ...
                                <p class="program-description">Prepares students for professional nursing practice through comprehensive theoretical and clinical training.</p>
                                
                                <h5 class="mt-4 mb-3" style="color: var(--arts-purple);">Program Features:</h5>
                                <ul class="program-features">
                                    <li>Anatomy and Physiology</li>
                                    <li>Nursing Fundamentals and Ethics</li>
                                    <li>Medical-Surgical Nursing</li>
                                    <li>Maternal and Child Health Nursing</li>
                                    <li>Community Health Nursing</li>
                                    <li>Nursing Research and Leadership</li>
                                </ul>
                            </div>
                        </div>
                    </div>
